...
public class FastPickaxeItem extends AtarikafasRandomEventModElements.ModElement {
	@ObjectHolder("atarikafas_random_event:fast_pickaxe")
	public static final Item block = null;
	public FastPickaxeItem(AtarikafasRandomEventModElements instance) {
		super(instance, 28);
	}
