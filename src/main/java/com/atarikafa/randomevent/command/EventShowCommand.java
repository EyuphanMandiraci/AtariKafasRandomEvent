...
import com.atarikafa.randomevent.procedures.EventShowCommandExecutedProcedure;
import com.atarikafa.randomevent.AtarikafasRandomEventModElements;

@AtarikafasRandomEventModElements.ModElement.Tag
public class EventShowCommand extends AtarikafasRandomEventModElements.ModElement {
	public EventShowCommand(AtarikafasRandomEventModElements instance) {
		super(instance, 4);
	...
	private LiteralArgumentBuilder<CommandSource> customCommand() {
		return LiteralArgumentBuilder.<CommandSource>literal("eventshow")
