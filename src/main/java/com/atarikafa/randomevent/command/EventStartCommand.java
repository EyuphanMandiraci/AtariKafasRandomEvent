...
import com.atarikafa.randomevent.procedures.EventStartCommandExecutedProcedure;
import com.atarikafa.randomevent.AtarikafasRandomEventModElements;

@AtarikafasRandomEventModElements.ModElement.Tag
public class EventStartCommand extends AtarikafasRandomEventModElements.ModElement {
	public EventStartCommand(AtarikafasRandomEventModElements instance) {
		super(instance, 16);
	...
	private int execute(CommandContext<CommandSource> ctx) {
		...
		});
		{
			...
			EventStartCommandExecutedProcedure.executeProcedure($_dependencies);
		}
		return 0;
	}
}
