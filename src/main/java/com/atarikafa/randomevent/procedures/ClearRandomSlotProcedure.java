...
public class ClearRandomSlotProcedure extends AtarikafasRandomEventModElements.ModElement {
	public ClearRandomSlotProcedure(AtarikafasRandomEventModElements instance) {
		super(instance, 24);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				AtarikafasRandomEventMod.LOGGER.warn("Failed to load dependency entity for procedure ClearRandomSlot!");
			return;
		}
